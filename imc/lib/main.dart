          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              TextFormField(
                ...
                decoration: InputDecoration(labelText: "Peso (kg)", labelStyle: TextStyle(color: Colors.red)),
              ...
              Text(_textInfo, textAlign: TextAlign.center, style: TextStyle(color: Colors.red, fontSize: 25.0)              )
            ], 
          ),
        ),
      ),
